...
for seed in SEEDS:
  ...
  for i in range(0, 11):
      ...
      chebyshev = MOQLearning(env, scalarization=weighted_sum,initial_epsilon=1,final_epsilon=0.1,epsilon_decay_steps=400000, gamma=0.9, weights=weights,seed=seed, log=False)
  ...
  log_results(pf,hypervolume_scores,cardinality_scores,igd_scores,sparsity_scores,"Research Project Logs V7",exp_name,"MO Q Learning with Linear Scalarization in DST Concave")
