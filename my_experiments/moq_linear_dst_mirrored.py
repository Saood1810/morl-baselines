...
for seed in SEEDS:
  ...
  exp_name = f"Balanced Linear Experiment in DST Mirrored with seed {seed}"
  ...
  log_results(pf,hypervolume_scores,cardinality_scores,igd_scores,sparsity_scores,"Research Project Logs V6",exp_name,"MOQ Linear DST Mirrored")
