...
for seed in SEEDS:
  ...
  log_results(pf,hypervolume_scores,cardinality_scores,igd_scores,sparsity_scores,"Balanced MOQ Chebyshev Scalarized DST ",exp_name,"Balanced MOQ Chebyshev DST")
