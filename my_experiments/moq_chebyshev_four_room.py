...
for seed in SEEDS:
  ...
  log_results(pf,hypervolume_scores,cardinality_scores,igd_scores,sparsity_scores,"Research Project Logs V4",exp_name,"Balanced Chebyshev Linear Resource Gathering")
