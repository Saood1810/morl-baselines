...
for seed in SEEDS:
    wandb.init(mode="offline",project="Research Project Logs V6",group="Pareto Q-Learning in DST Mirrored",name="Pareto Q-Learning in DST Mirrored with seed "+str(seed))
