...
for seed in SEEDS:
  ...
  exp_name = f"FINAL GREEDY Cheby Experiment G 0.9 with seed {seed}"
  ...
  for i in range(0, 11):
      ...
      chebyshev = MOQLearning(env, scalarization=scalarization,initial_epsilon=0.1,final_epsilon=0.1, gamma=0.9, weights=weights,seed=seed, log=False)
